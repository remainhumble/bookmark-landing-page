    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center gap-1 py-4 px-0 bg-blue-600" id="contact">
                ...
                <form className="gap-2 mt-4 flex flex-col sm:flex-row justify-center items-center">
                    ...
                    <button className="w-full max-w-xs px-4 py-2 border-2 bg-red-400 border-red-400 text-white rounded-sm hover:text-red-400 hover:bg-white">Contact Us</button>
                </form>
            </div >
        </>
    )
