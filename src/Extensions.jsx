        ...
        <>
            <div className="flex flex-col justify-center items-center gap-4 py-4 px-2">
                ...
                <div className="flex flex-col md:flex-row justify-center gap-8 mt-4">
                    <div className="py-4 rounded-sm flex flex-col justify-center items-center shadow-xl">
                        <img src={imgs.chrome} alt="Chrome" />
                        <h3 className="text-blue-950 text-xs my-2">Add to Chrome</h3>
                    ...
                    <div className="py-4 rounded-sm flex flex-col justify-center items-center shadow-xl">
                        ...
                        <h3 className="text-blue-950 text-xs my-2">Add to Firefox</h3>
                    ...
                    <div className="py-4 rounded-sm flex flex-col justify-center items-center shadow-xl">
                        ...
                        <h3 className="text-blue-950 text-xs my-2">Add to Opera</h3>
