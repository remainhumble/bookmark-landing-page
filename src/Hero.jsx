...
const App = () => {
    return (
        <div>
            ...
            <h1 className="text-[32px] text-blue-950 font-medium">A Simple Bookmark Manager</h1>
            <p className="text-gray-500 font-normal text-xs">A clean and simple interface to organize your favorite websites. Open a new browser tab and see your sites load instantly. Try it for free.</p>
