...
const Footer = () => {
    return (
        <footer className="footer-section bg-blue-950 text-white flex flex-col sm:flex-row justify-center items-center py-5 sm:py-0">
            ...
            <div className="footer-social flex flex-row gap-4 p-4 sm:py-1">
                <a href="https://facebook.com"><img src={imgs.iconFacebook} alt="facebook" /></a>
